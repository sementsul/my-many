...
# Подтверждение прав в поисковых панелях (мета-теги). Яндекс допускает несколько (разные аккаунты).
# Google добавим, когда пришлёт свой код.
VERIFY = ('<meta name="yandex-verification" content="20a164d4865dd35c" />'
          '<meta name="yandex-verification" content="d5dd2e5c5d4ee324" />')
